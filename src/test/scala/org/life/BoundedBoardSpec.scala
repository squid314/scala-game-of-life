...
class BoundedBoardSpec extends FlatSpec with Matchers {
    ...
    "Board" should "be able to find the neighbors of the top left corner in the center layout" in {
    ...
    "Board" should "be able to find the neighbors of the middle left cell of the center layout" in {
    ...
    "Board" should "be able to find the neighbors of the middle center cell of the center layout" in {
    ...
    "Board" should "be able to find the neighbors of the top left cell in the blinker layout" in {
    ...
    "Board" should "recognize starvation rule" in {
        assert( center.nextBoard( )( 1, 1 ) == false )
    }

    "Board" should "recognize live survival rule for 2 neighbors" in {
        assert( blinkerHorizontal.nextBoard( )( 1, 1 ) == true )
    }

    "Board" should "recognize live survival rule for 3 neighbors" in {
        assert( box.nextBoard( )( 1, 1 ) == true )
    }

    "Board" should "recognize dead survival rule for 2 neighbors" in {
        assert( blinkerHorizontal.nextBoard( )( 0, 0 ) == false )
    }

    "Board" should "recognize overpopulation rule" in {
        assert( full.nextBoard( )( 1, 1 ) == false )
    }

    "Board" should "recognize spawning rule" in {
